...
<head>
    ...
    <title>Mesoil | Tài khoản khách hàng</title>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <table class="table table-striped table-bordered">
                    ...
                    ?>
                    <tr>
                		<td><?php echo $KH['customer_id']; ?></td>
                        <td><?php echo $KH['name']; ?></td>
                        <td><?php echo $KH['username']; ?></td>
                        <td><?php echo $KH['password']; ?></td>
                        <td><?php echo date_format(new DateTime($KH['birthday']),"d-m-Y"); ?></td>  
                        <td><?php echo $KH['phone']; ?></td>
                        <td><?php echo $KH['email']; ?></td>      
                        <td>          
                        <a class="btn btn-danger" href="del_customers.php?id=<?php echo $KH['customer_id'];?>">Xóa</a>
                        </td>
                    </tr>    
                <?php               
                }
