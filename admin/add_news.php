...
<head>
    ...
    <title>Mesoil | Thêm tin tức</title>
    ...
    <script type="text/javascript">
      function validateForm()
      {
        ...
        var image = document.forms["form_them_tt"]["image"].value;
        var description = document.forms["form_them_tt"]["description"].value;
        ...
        if(image.trim()=="")
        {
            ...
            document.forms["form_them_tt"]["image"].focus();
            return false;
        }
        if(description.trim()=="")
        {
            alert("Bạn chưa nhập mô tả");
            document.forms["form_them_tt"]["description"].focus();
            return false;
        }
        /*if(content.trim()=="")
        {
...
<body>
	<div id="wrapper">
       ...
       <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
              <h1 align="center" style="padding-top: 10px">Thêm tin tức</h1>
              <form class="form form-horizontal" method="post" action="adding_news.php" id="form_them_tt" onsubmit="return(validateForm());" enctype="multipart/form-data">
                ...
                <!--<div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <textarea class="form-control" rows="30" id="content" name="content"></textarea>
                </div>-->
                <div class="form-group">
                    <label class="control-label col-sm-2">Nội dung</label>
                    <div class="col-sm-10">
                    <div id="summernote"><p>Nội dung</p></div>
                      <script>
