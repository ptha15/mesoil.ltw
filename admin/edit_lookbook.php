...
<head>
    ...
    <title>Mesoil | Sửa thể loại</title>
...
<body>
	<div id="wrapper">
       ...
       <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
              <h1 align="center" style="padding-top: 10px">Sửa thể loại</h1>
              <form class="form form-horizontal" method="post" action="thuc_hien_edit_lookbook.php" id="form_them_lb" onsubmit="return(validateForm());" enctype="multipart/form-data">
